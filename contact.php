...
<div class="card card-body blur shadow-blur mx-3 mx-md-4 mt-n6 mb-4 bg-main card_page">
  <!-- START Testimonials w/ user image & text & info -->

  <section class="py-sm-7 py-5 position-relative">
    <div class="row py-5">
      <section class="py-lg-5 bg-main">
        <div class="container">
          <div class="row">
            <div class="col">
                    ...
                    <div class="z-index-2 text-center d-flex h-100 w-100 d-flex m-auto justify-content-center">
                      ...
                      <div class="p-5 ps-sm-8 position-relative text-start my-auto z-index-2">
                        ...
                        <div class="d-flex p-2 text-white">
                          ...
                          <div class="ps-3">
                            <span class="text-sm opacity-8">+971 50 209 2894 </span>
                          </div>
                        </div>
                        <div class="d-flex p-2 text-white">
                          <div>
                          ...
                          <div class="ps-3">
                            <span class="text-sm opacity-8">askkayzar@smoky-arabia.com</span>
                          </div>
                        </div>
                        <div class="d-flex p-2 text-white">
                          <div>
                          ...
                          <div class="ps-3">
                            <span class="text-sm opacity-8">Ras Al Khaimah, Dubai 010458</span>
                          </div>
                        </div>
                        <div class="mt-4">
                      ...
                      <div class="card-body pt-1">
                        ...
                        <div class="row">
                          <div class="col-md-6 text-end ms-auto">
                            <a href="" class="btn btn-sm btn-main mb-0 me-1 mt-2 mt-md-0"> Send A Message</a>
                          </div>
                        </div>
                      </div>
                    </form>
